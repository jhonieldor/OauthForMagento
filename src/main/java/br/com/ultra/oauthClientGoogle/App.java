...
public class App {
    ...
    private static final String CALLBACK = MAGENTOLOCALHOST;

    private static final String BASE_URL = MAGENTOLOCALHOST;
    ...
    public static void main(String[] args) {
        final String MAGENTO_API_KEY = MAGENTO_API_KEY_LOCALHOST;
        final String MAGENTO_API_SECRET = MAGENTO_API_SECRET_LOCALHOST;
...
//            ProductBootstrap pb = new ProductBootstrap();
           ...
           // Order order = gson.fromJson(responseOrder, Order.class);
            ...
            HashMap<String, Order> orderMaps = gson.fromJson(responseOrder, new TypeToken<HashMap<String, Order>>() {}.getType());
...
//            Collection<Order> orders = gson.fromJson(responseOrder, collectionType);
            ...
            HashMap<String, Customer> customersMap = gson.fromJson(customers, new TypeToken<HashMap<String, Customer>>() {}.getType());
